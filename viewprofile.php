                          		                            ...
                          		                            <form action="updateprofile.php">
                                                                ...
                                                                <div class="control-group">
                                  		                            <div class="input-group">
                               		                                ...
                               		                                <div class="control-group">
                                    	                                <div class="input-group">
                                        	                                <input type="email" name="mail" class="form-control" value="<?php echo $row['email'];?>" readonly/>
                                        		                            <div class="input-group-append">
                                                                        ...
                                                                        <div class="control-group">
                                                                            <div class="input-group">
                                        	                                    <input type="tel" pattern="[0-9]{10}" minlength="10" name="contact" class="form-control" maxlength="10" value="<?php echo $row['phone'];?>" readonly/>
                                        		                                <div class="input-group-append">
                                                                    ...
                                                                    ?>
                                                                            <button class="btn custom-btn" type="submit" name="submit">Edit Profile</button>   
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>  
