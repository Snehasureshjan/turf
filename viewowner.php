                                ...
                                <div class="section-header text-center">
                                    ...
                                    <div id="all" class="container tab-pane active"> 
                                        ...
                                        <table border="5" align="center">
                                            <tr><th><h5>Name </h5></th> <th><h5> Email </h5> </th> <th><h5> Contact</h5> </th> <th><h5> ID Proof</h5> </th> <th> Status</th></tr>                                       
                                        
                                        <?php
                                            include'DatabaseCon.php';
                                            $sql="select * from login inner join owner on owner.oid=login.uid";
                                        ...
                                        <?php 
                                            ...
                                            {
                                        ?>
                                                <td> <a href="ownapprove.php?id=<?php echo $row['uid'];?>"> approve </a> </td>
                                                <td> <a href="ownreject.php?id=<?php echo $row['uid'];?>"> reject </a> </td>
                                        <?php
                                            }      
                                        ?>                        
                                                </tr> 
