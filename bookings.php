            ...
            <div class="row">
                <div class="col-12">
                    <div class="carousel-text">
                        <h1 style="color:white;"> WELCOME  <?php echo $nm?></h1>
                    </div>                                         
                </div>
            </div>
        </div>
                    ...
                    <div id="all" class="container tab-pane active">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <tr><th><h5>TurfName</h5></th><th><h5>Game</h5></th><th><h5>Match Date</h5></th><th><h5>Start Time</h5></th><th><h5>End Time</h5></th><th><h5>Booked On</h5></th></tr>
    
                            <?php                                 
                                $q="select * from bookturf where rid='$no' AND pstatus='paid'";
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <td>
                                        <a href="delbooking.php?n=<?php echo $row['bid'];?> ">Cancel</a>
                                    </td>
                                </tr>
                                <?php
                                   }
